...
const SaveSettings = async (newInfo) => {
	...
	try {
		...
		if (payloadSettings.error) throw payloadSettings.error;
...
app.get('/events/list/googleCalendar', tryCatch(async (req, res) => {
		let error = {};
...
app.get('/events/list/markdown', tryCatch(async (req, res) => {
		const settings = await loadSavedSettings();
...
app.get('/events/sync', tryCatch(async (req, res) => {
		let syncedObj = {tasks: []},
			err = {},
...
app.get('/settings/load', tryCatch(async (req, res) => {
...
app.post('/settings/save', tryCatch(async (req, res) => {
...
app.get('/log-in', tryCatch(async (req, res) => {
...
app.post('/log-out', tryCatch(async (req, res) => {
...
app.post('/client/save', tryCatch(async (req, res)=>{
	console.log(req);
